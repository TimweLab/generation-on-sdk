...
@objc public class ExchangePointsToAttemptResponse:NSObject, Codable{
    ...
    public var exchangeDescription:String?//NSObject already has a description field
    ...
    @objc public func getExchangeDescription() -> String{
        return exchangeDescription == nil ? "" : exchangeDescription!
    }
    
    @objc public func setExchangeDescription(_ value:String){
        self.exchangeDescription = value
    }
